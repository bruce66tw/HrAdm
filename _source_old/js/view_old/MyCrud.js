var _me = {
    ...
    init: function () {
        ...
        */
        _me.eMaster = new EditOne();
        _me.mQitem = new EditMany('Id', 'formEditQitem', 'tplQitem');
        _me.mRitem = new EditMany('Id', 'formEditRitem', 'tplRitem');
        _me.mEtable = new EditMany('Id', null, 'tplTabEtable', false);
        _me.mEitem = new EditMany('Id', null, 'tplEitemTr', true);
        _me.mEtable._childs = [_me.mEitem];

        _crud.init(config, [_me.eMaster, _me.mQitem, _me.mRitem, _me.mEtable]);
        ...
        //custom function
        _me.eMaster.ufAfterLoadJson = _me.eMaster_AfterLoadJson;
        _me.eMaster.ufWhenSave = _me.eMaster_WhenSave;
        //
    ...
    //called by eMaster_AfterLoadRow()
    eMaster_AfterLoadJson2: function (json) {
    ...
    */
    ...
    mEtable_GetUpdJson: function () {
        ...
        _me.getEtableForms().each(function (i, item) {
            ...
            _me.mEtable.rowSetMapId(rows[i], upKey);
    ...
    mEitem_GetUpdRows: function () {
        ...
        _me.getEtableForms().each(function (i, item) {
            ...
            //set data mapId !!
            //if (rows2 != null)
            //    _me.mEitem.rowsSetMapId(rows2, _iText.get('Id', form));
